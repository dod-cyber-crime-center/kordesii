...
class FPURegisters(RegisterMap):
    ...
    def __init__(self):
        registers = [
            # control word
            Register(2, ic=0x1000, rc=0xc00, pc=0x300, iem=0x80, pm=0x20, um=0x10,
                        om=0x8, zm=0x4, dm=0x2, im=0x1),
            # status word
            # TODO: IA-32 x87 indicates differently...
            Register(2, b=0x4000, c3=0x2000, top=0x1c00, c2=0x400, c1=0x200, c0=0x100, ir=0x80,
                        sf=0x40, p=0x20, u=0x10, o=0x8, z=0x4, d=0x2, i=0x1),
            # tag word
            ...
            Register(2, tag7=0xc000, tag6=0x3000, tag5=0xc00, tag4=0x300,
                        tag3=0xc0, tag2=0x30, tag1=0xc, tag0=0x3)
        ]
