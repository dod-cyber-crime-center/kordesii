...
def make_opt_parser():
    ...
    opt_parser.add_option('-t', '--timeout',
                          ...
                          default = 10,
                          dest = 'timeout',
                          help = 'Timeout for running IDA (default = %default). A timout of 0 disables ' +
                                 'the timeout.')
    opt_parser.add_option('-x',
                          ...
                          help = 'Disable cleanup of txt files generated by IDA (ida_strings.txt, ida_log.txt, ida_debug.txt)')                             
