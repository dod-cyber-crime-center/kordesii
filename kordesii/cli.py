...
@click.option('--decoder-dir', type=click.Path(exists=True, file_okay=False),
              help="Optional extra decoder directory.",
              envvar='KORDESII_DECODER_DIR', show_envvar=True)
@click.option('--decoder-source',
              help="Set a default decoder source to use. "
                   "If not, registered decoders from all sources will be available.",
              envvar='KORDESII_DECODER_SOURCE', show_envvar=True)
...
@click.option('-m', '--tempdir', type=click.Path(file_okay=False),
...
@click.option('-t', '--testcase-dir', type=click.Path(exists=True, file_okay=False),
              ...
              envvar='KORDESII_TESTCASE_DIR', show_envvar=True)
@click.option('-m', '--malware-repo', type=click.Path(exists=True, file_okay=False),
              ...
              envvar='KORDESII_MALWARE_REPO', show_envvar=True)
